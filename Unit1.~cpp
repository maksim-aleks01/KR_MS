...
////////////////////////////////////////////////////////////////////////////////
  ...
  double Mu=0;
  //double *MuArray = new double [ADOTable1->RecordCount]; //массив значений Мю
  double MuArray [100]; for (int i=0; i<100; i++) MuArray[i] = 0;
  ...
  double Str0Array [100]; for (int i=0; i<100; i++) Str0Array[i] = 0;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  double AlArray [100]; for (int i=0; i<100; i++) AlArray[i] = 0; // обнуляем массив
 ...
 for(int i=0; i<ADOTable1->RecordCount; i++)
   {
    StringGrid3->Cells[3][i+1] = MuArray[i] + E; //Mu+
    StringGrid3->Cells[4][i+1] = MuArray[i] - E; //Mu-
    StringGrid3->Cells[5][i+1] = AlArray[i] + E; //Alpha+
    StringGrid3->Cells[6][i+1] = AlArray[i] - E; //Alpha-
   }
